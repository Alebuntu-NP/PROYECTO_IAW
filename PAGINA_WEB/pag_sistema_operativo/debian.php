...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="../css/debian.css" />
...
<?php
    ...
    <div class="container">
      ...
      <ul class="nav nav-pills" role="tablist">
        ...
        <li class="nav-item">
          <a class="nav-link active" data-toggle="pill" href="#version">Versiones</a>
        </li>
      ...
      <div class="tab-content">
        ...
        <div id="version" class="container tab-pane active"><br>
          <div class="col-md-9">
            <div class="card">
              <div class="card-body">
                <div class="row">
